...
from sqlalchemy import String, Column, Integer, DateTime, Float, ForeignKey, MetaData, create_engine
from sqlalchemy.orm import relationship
import datetime


# 自行配置
engine = create_engine('mysql+mysqlconnector://connect:XXX@XXX.XXX.XXX.XXX:3306/print?charset=utf8',echo=True) 
